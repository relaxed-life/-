...
//		static BYTE parms[] = VTS_BOOL;
//		InvokeHelper(0x22, DISPATCH_METHOD, UNSIGNED LONG, (void*)&result, parms, CheckBackgroundColor);
//		return result;
//	}
...
//	}
//	void OnGetSeriesPointerStyle(long SeriesIndex, long ValueIndex, EPointerStyle * AStyle)
//	{
//		static BYTE parms[] = VTS_I4 VTS_I4 VTS_UNKNOWN;
//		InvokeHelper(0x21, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, SeriesIndex, ValueIndex, AStyle);
//	}
//	void OnGetSeriesContourLevel(long SeriesIndex, long LevelIndex, double * LevelValue, OLE_COLOR * LevelColor)
//	{
//		static BYTE parms[] = VTS_I4 VTS_I4 VTS_UNKNOWN VTS_UNKNOWN;
